...
![Open Adventure](docs/images/screenshots/final-agents.png)

**统一管理 Claude AI 生态的专业工具**

[![Version](https://img.shields.io/badge/version-0.2.0-blue.svg)](https://github.com/your-repo/open-adventure/releases)
[![License](https://img.shields.io/badge/license-MIT-green.svg)](LICENSE)
[![Platform](https://img.shields.io/badge/platform-macOS%20%7C%20Linux-lightgrey.svg)](https://github.com/your-repo/open-adventure)
...
Open Adventure 基于三大核心设计理念打造，为 AI 开发者提供全新的管理体验：
...
```bash
# 下载最新版本
curl -L -o open-adventure.tar.gz \
  https://github.com/your-repo/open-adventure/releases/download/v0.1.5/open-adventure-v0.1.5-macos-arm64.tar.gz

# 解压
tar -xzf open-adventure.tar.gz
cd open-adventure-v0.1.5-macos-arm64
...
# 下载最新版本
curl -L -o open-adventure.tar.gz \
  https://github.com/your-repo/open-adventure/releases/download/v0.1.5/open-adventure-v0.1.5-linux-x86_64.tar.gz

# 解压
tar -xzf open-adventure.tar.gz
cd open-adventure-v0.1.5-linux-x86_64
...
```bash
# 1. 克隆项目
git clone https://github.com/your-repo/open-adventure.git
cd open-adventure
...
如果你已经安装了旧版本，请先查看 [升级指南](docs/UPGRADE_GUIDE.md)。
...
- [Bug 报告](https://github.com/your-repo/open-adventure/issues/new?template=bug_report.md)
- [功能建议](https://github.com/your-repo/open-adventure/issues/new?template=feature_request.md)
...
Made with ❤️ by Open Adventure Team
