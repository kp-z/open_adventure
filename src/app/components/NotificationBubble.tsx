...
export const NotificationBubble: React.FC<NotificationBubbleProps> = ({
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end">
      <AnimatePresence>
        {isExpanded && hasNotifications && (
          <motion.div
            ...
            className="absolute bottom-16 right-0 w-96 max-h-[500px] bg-[#1a1b26] border border-white/10 rounded-2xl shadow-2xl overflow-hidden"
          >
            {/* Header */}
      ...
      {/* Floating Button - Only show when there are notifications */}
      {hasNotifications && (
        <motion.button
